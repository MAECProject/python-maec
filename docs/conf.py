# -*- coding: utf-8 -*-
#
# python-maec documentation build configuration file, created by
...
man_pages = [
    ('index', 'python-maec', u'python-maec Documentation',
...
texinfo_documents = [
  ('index', 'python-maec', u'python-maec Documentation',
   u'The MITRE Corporation', 'python-maec', 'One line description of project.',
   'Miscellaneous'),
]
